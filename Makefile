...
build-mips-unknown-linux-musl:
	...
	cross +nightly-2026-01-27 build -Z build-std=panic_abort,std --target mips-unknown-linux-musl --release
...
# Dependencies
dev-dependencies:
	cargo install cross --git https://github.com/cross-rs/cross --rev 452dc27a11d4f58d65309f8455c5cf7558f60513 --locked --root .cargo -f
