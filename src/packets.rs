...
mod test {
    ...
    fn test_downlink_metadata_from_bytes() {
        ...
        let tests = vec![Test {
            ...
            bytes: [0x40, 0x03, 0x84, 0x76, 0x28, 0x0f],
            expected_metadata: DownlinkMetadata {
                uplink_id: 1024,
                dr: 3,
                frequency: 868100000,
    ...
    #[test]
    fn test_downlink_metaata_to_bytes() {
        struct Test {
            name: String,
        ...
        let tests = vec![
            ...
            Test {
                ...
                expected_bytes: Some([0x40, 0x03, 0x84, 0x76, 0x28, 0x0f]),
                expected_error: None,
            },
        ];
    ...
    fn test_downlink_payload_from_slice() {
        let b = vec![
            0x40, 0x03, 0x84, 0x76, 0x28, 0x0f, 0x01, 0x02, 0x03, 0x04, 0x05,
        ];
    ...
    fn test_downlink_payload_to_vec() {
        ...
        assert_eq!(
            vec![0x40, 0x03, 0x84, 0x76, 0x28, 0x0f, 0x01, 0x02, 0x03, 0x04, 0x05,],
            b
        );
    }
    ...
    fn test_relay_packet_from_slice() {
        ...
        let tests = vec![
            ...
            Test {
                name: "downlink".into(),
                bytes: vec![
                    0xef, 0x40, 0x03, 0x84, 0x76, 0x28, 0x0f, 0x01, 0x02, 0x03, 0x04, 0x05,
                ],
                expected_relay_packet: RelayPacket {
                    mhdr: MHDR {
                        payload_type: PayloadType::Downlink,
